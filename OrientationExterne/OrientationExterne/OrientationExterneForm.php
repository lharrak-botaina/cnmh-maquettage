                    ...
                    <div class="col-md-12 d-flex justify-content-center">
                        ...
                        <div class="card card-primary card-create">
                            <div class="card-header">
                                <h3 class="card-title">Ajouter orientation</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="..php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-footer">
                                    <div class="d-flex justify-content-between">
                                        <a href="../OrientationExterne/OrientationExterneManager.php" class="btn btn-primary">Enregistrer</a>
                                        <a href="../OrientationExterne/OrientationExterneManager.php" class="btn btn-outline-secondary">Annuler</a>
                                    </div>
                                </div>
                        </div>
                        </form>
